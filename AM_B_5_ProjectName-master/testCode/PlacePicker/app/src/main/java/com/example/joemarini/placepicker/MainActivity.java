package com.example.joemarini.placepicker;
...
public class MainActivity extends AppCompatActivity
    ...
    private void updateUI(Place chosenPlace) {
        TextView currentLocation = (TextView)findViewById(R.id.currentLocationDisplayNameTextView);
        TextView currentLocationAddress = (TextView)findViewById(R.id.tvPickerAddressDisplay);

        String placeName = chosenPlace.getName() + "";
        String placeAddress = chosenPlace.getAddress() + "";

        currentLocation.setText(placeName);
        currentLocationAddress.setText(placeAddress);
    }
